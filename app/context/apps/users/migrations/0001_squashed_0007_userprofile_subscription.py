...
class Migration(migrations.Migration):
    ...
    replaces = [(b'users', '0001_initial'), (b'users', '0002_userprofile_is_microservice_user'), (b'users', '0003_auto_20160225_2121'), (b'users', '0004_auto_20160226_0223'), (b'users', '0005_auto_20160307_1813'), (b'users', '0006_auto_20160307_1813'), (b'users', '0007_userprofile_subscription')]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_microservice_user', models.BooleanField(default=False)),
            ],
        ),
        migrations.CreateModel(
            name='Company',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('features', models.ManyToManyField(blank=True, to=b'users.Feature')),
            ],
        ),
        migrations.AddField(
            model_name='company',
